...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url().'assets/armor/'; ?>dist/css/skins/_all-skins.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>A.G.S</b> CMS</span>
    </a>
  </header>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li>
          <a href="<?php echo base_url().'admin/cms'; ?>">
            <i class="fa fa-edit"></i> <span>Content - Home</span>
          </a>
        </li>
        <li class="active">
          <a href="<?php echo base_url().'admin/about'; ?>">
            <i class="fa fa-edit"></i> <span>Content - About Us</span>
          </a>
        </li>
        <li>
          <a href="<?php echo base_url().'admin/catalog'; ?>">
            <i class="fa fa-edit"></i> <span>Content - Catalog</span>
          </a>
        </li>
        <li>
          <a href="<?php echo base_url().'admin/contacts'; ?>">
            <i class="fa fa-edit"></i> <span>Content - Contact Us</span>
          </a>
        </li>
      </ul>
    </section>
...
<!-- Slimscroll -->
<script src="<?php echo base_url().'assets/armor/'; ?>bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="<?php echo base_url().'assets/armor/'; ?>bower_components/fastclick/lib/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="<?php echo base_url().'assets/armor/'; ?>dist/js/adminlte.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?php echo base_url().'assets/armor/'; ?>dist/js/demo.js"></script>
</body>
</html>
